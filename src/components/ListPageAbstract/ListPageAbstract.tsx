...
export default function ListPageAbstract() {
  return (
    <div className=" flex items-center justify-center  h-screen bg-cream p-5 max-tablet:relative">
      ...
      <img className='max-w-72 max-tablet:max-w-52 max-tablet:absolute max-tablet:top-1/2 max-tablet:left-1/2 max-tablet:-translate-x-1/2 max-tablet:-translate-y-1/2 max-tablet:opacity-25' src='../../../../public/list_page/ornament.png' alt="" />
    </div>
  )
}