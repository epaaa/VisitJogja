...
export default function ListPageAbstract() {
  ...
  return (
    <div className=" flex items-center justify-center  h-screen bg-cream p-5 max-tablet:relative">
      ...
      <img src={dataContext.imageDic['ornament.png']} className='max-w-64 max-tablet:max-w-52 max-tablet:absolute max-tablet:top-1/2 max-tablet:left-1/2 max-tablet:-translate-x-1/2 max-tablet:-translate-y-1/2 max-tablet:opacity-25' alt="" />
    </div>
  )
}