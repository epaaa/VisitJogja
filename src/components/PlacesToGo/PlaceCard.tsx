...
export default function PlaceCard({ placePic, placeName, placeURL } : PlaceCardInterface) {
  return (
    <Link to={placeURL} className="flex flex-col p-3 m-1 rounded-lg transition duration-300 ease-in-out transform hover:scale-105">
