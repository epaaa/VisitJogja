...
export default function AutoBudgetin() {
    ...
    return (
        <div className="flex flex-col gap-5 max-w-96">
            ...
            <div className="text-center text-xl font-semibold max-mobile:text-sm">Enter your budget and how many days you want to stay. Voila! All the recommendations for your vacation will be shown.</div>
