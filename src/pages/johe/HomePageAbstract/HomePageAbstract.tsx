...
export default function HomePageAbstract() {
  return (
    <div className="relative flex items-center justify-center  h-screen bg-cream p-5">
      ...
      <img className='z-0 max-w-80 absolute top-1/2 right-0 -translate-y-1/2 max-mobile:max-w-64 max-tablet:opacity-20' src='../../../../public/list_page/wayang-gunungan.png' alt="" />
    </div>
  )
}